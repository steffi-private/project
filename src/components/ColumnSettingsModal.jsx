...
/**
 * @typedef {Object} ColumnSettingsModalProps
 * @property {boolean} isOpen - Whether the modal is open
 * @property {function(): void} onClose - Callback to close the modal
 * @property {Column[]} columns - Array of column objects
 * @property {function(string, Partial<Column>): void} onUpdateColumn - Callback to update column properties
 */
...
/**
 * ColumnSettingsModal component for customizing column appearance
 * @param {ColumnSettingsModalProps} props - Component props
 * @returns {JSX.Element|null}
 */
export default function ColumnSettingsModal({ isOpen, onClose, columns, onUpdateColumn }) {
  ...
  /**
   * Handle canceling changes and resetting form
   */
  const handleCancel = () => {
    setEditingColumns(columns);
    onClose();
