 ...
 * @property {Column} column - Column configuration object
 * @property {Task[]} tasks - Array of tasks in this column
 * @property {function(string, Partial<Task>): void} onUpdateTask - Callback for task updates
 * @property {function(string): void} onDeleteTask - Callback for task deletion
 */

/**
 * KanbanColumn component for displaying a column of tasks
